...
function init(plan){
    ...
    if(plan.toLowerCase().indexOf("free") > -1){
        ...
        $myPlanCurrentNode = 
            ...
            ' </div>\n' +
            ' <div class="my-plan-current-plan-option-holder">\n'+
            '  <p>The lifespans of job offers are 7 days</p>\n' +
            '  <div class="my-plan-current-plan-option-underline"></div>\n' +
            ' </div>\n' +
            '</div>\n'
        ...
        $myPlanUpgrade1 = 
            ...
            ' </div>\n' +
            ' <div class="option-description">\n' +
            '  <p>The lifespans of job offers are 30 days</p>\n' +
            ' </div>\n' +
            ' <div class="upgrade-button-for-plus" style="background-color: #4BC4BE;" onclick="window.location = \'/company-dashboard/plan-payment.html?purchaseType=upgradeToPlus\'">\n' +
            '  <p>Upgrade</p>\n' +
            ' </div>\n' +
            '</div>\n'
        ...
        $myPlanUpgrade2 = 
            ...
            ' </div>\n' +
            ' <div class="upgrade-button-for-plus" style="background-color: rgba(237, 179, 76, 0.9);" onclick="window.location = \'/company-dashboard/plan-payment.html?purchaseType=upgradeToPremium\'">\n' +
            '  <p>Upgrade</p>\n' +
            ' </div>\n' +
            '</div>\n'
